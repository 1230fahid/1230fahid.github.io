...
function App() {
  ...
  return (
    <>
      <div className="app">
        <div className={toggle ? "app-navbar active" : "app-navbar"}>
          ...
          <div className="drop-down-container">
            <div className={toggle ? "drop-down active" : "drop-down"} onClick={handleToggle}>
              <span></span>
              <span></span>
              <span></span>
            </div>
          ...
          <div className="navbar-contacts">
            ...
            <div className="navbar-contact">
              <a href="https://github.com/1230fahid">
